#include "wasserstein_nms_cuda_kernel.cuh"
...
Tensor WassersteinNMSCUDAKernelLauncher(Tensor boxes, Tensor scores, float iou_threshold,
  ...
  wasserstein_nms_cuda<<<blocks, threads, 0, stream>>>(
      boxes_num, iou_threshold, offset, constant, boxes_sorted.data_ptr<float>(),
